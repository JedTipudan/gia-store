...
class _FoodScreenState extends State<FoodScreen> {
  ...
  Future<void> _toggleToday(Map item) async {
              ...
              child: _items.isEmpty
                  ...
                  : GridView.builder(
                      ...
                      itemBuilder: (_, i) {
                        ...
                        final isToday = item['availableToday'] ?? false;
                        return Card(
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            Stack(children: [
                              FoodImage(
                                ...
                                placeholder: Container(
                                  ...
                                  child: Center(child: Icon(Icons.fastfood_rounded,
                                      size: 48, color: isActive ? const Color(0xFF16a34a) : Colors.grey[400])),
                                ),
                              ),
                              ...
                              Positioned(top: 8, left: 8,
                                child: GestureDetector(
                                  onTap: () => _toggleToday(item),
                                  child: Container(
                                    padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 3),
                                    decoration: BoxDecoration(
                                      color: isToday ? Colors.orange : Colors.black54,
                                      borderRadius: BorderRadius.circular(9999)),
                                    child: Text(isToday ? '☀ Today' : '+ Today',
                                        style: GoogleFonts.outfit(fontSize: 9,
                                            fontWeight: FontWeight.w600, color: Colors.white)),
                                  ),
                                )),
                                ...
                                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  ...
                                  Text(formatPeso(item['price']),
                                      style: GoogleFonts.outfit(fontWeight: FontWeight.bold,
                                          color: const Color(0xFF16a34a), fontSize: 14)),
                                  Text('Stock: ${item['stock']}',
                                      style: GoogleFonts.outfit(fontSize: 10, color: Colors.grey)),
                                ]),
                                Row(children: [
                                  Expanded(child: _actionBtn(Icons.edit,
                                      const Color(0xFFDBEAFE), const Color(0xFF2563eb),
                                      () => _openForm(Map<String, dynamic>.from(item)))),
                                  const SizedBox(width: 6),
                                  Expanded(child: _actionBtn(Icons.delete,
                                      const Color(0xFFFEE2E2), Colors.red,
                                      () => _delete(item))),
                                ]),
                              ]),
                            )),
  ...
  Future<void> _pickImage() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (mounted) showSnack(context, 'Upload failed: ${response.statusCode}', error: true);
      }
    } catch (e) {
      setState(() => _uploading = false);
      if (mounted) showSnack(context, 'Upload error: $e', error: true);
    }
  }
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            child: Container(
              ...
              child: _uploading
                  ? Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      Text('Uploading image...', style: GoogleFonts.outfit(color: Colors.grey)),
                    ])
                  : _pickedImage != null
          ...
          Center(child: TextButton.icon(
            ...
            label: Text(
              _imageUrl.isEmpty ? 'Add Photo from Gallery or Camera' : 'Change Photo',
              style: GoogleFonts.outfit(color: const Color(0xFF16a34a),
                  fontWeight: FontWeight.w600)),
          )),
          if (_imageUrl.isNotEmpty)
            Center(child: Text('✓ Image saved',
                style: GoogleFonts.outfit(fontSize: 12,
                    color: const Color(0xFF16a34a)))),
          const SizedBox(height: 16),
          _field(_name, 'Food Name *'),
          _field(_desc, 'Description'),
          _field(_cat, 'Category (e.g. Rice, Viand, Snack)'),
          Row(children: [
          ...
          SwitchListTile(
            ...
            subtitle: Text('Customers will see this today',
                style: GoogleFonts.outfit(fontSize: 11, color: Colors.grey)),
