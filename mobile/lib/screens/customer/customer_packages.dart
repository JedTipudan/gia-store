...
class _CustomerPackagesState extends State<CustomerPackages> {
  ...
  String _getApplicationStatus(int packageId) {
    final app = _myApplications
        .where((m) => m['paluwaganPackage']?['id'] == packageId)
        .toList();
      ...
      child: ListView(padding: const EdgeInsets.all(16), children: [
        ...
        if (_hasActiveEnrollment) ...[
          Container(
            ...
            child: Row(children: [
              const Icon(Icons.info_outline, color: Color(0xFF4ade80), size: 20),
              const SizedBox(width: 12),
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text('You already have a paluwagan enrollment.',
                    style: GoogleFonts.outfit(fontWeight: FontWeight.w600,
                        color: Colors.white)),
                Text('Only 1 paluwagan is allowed per customer. '
  ...
  Widget _applicationCard(Map m) {
    ...
    final Map<String, Color> colors = {
      'PENDING': Colors.orange, 'ACTIVE': const Color(0xFF4ade80),
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              if (isFull)
                ...
                _badge('$slotsLeft slots left', const Color(0xFF4ade80)),
            ]),
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: canApply
                      ? const Color(0xFF16a34a) : Colors.grey[800],
                  foregroundColor: Colors.white,
                  shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(10)),
